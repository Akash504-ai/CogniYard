  ...
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3.5">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl space-y-1.5 shadow-2xs">
          <span className="text-[10px] font-semibold text-indigo-500 uppercase tracking-wider block">Info</span>
          <div className="text-xl font-bold font-mono text-indigo-600 dark:text-indigo-400">{summary.infoCount}</div>
        </div>
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl space-y-1.5 shadow-2xs">
      ...
      <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-4 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="bg-zinc-50 dark:bg-zinc-950 text-xs font-semibold text-zinc-800 dark:text-zinc-200 border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-2 focus:outline-none focus:ring-1 focus:ring-indigo-500 cursor-pointer"
          >
                ...
                <tr key={ex._id} className="hover:bg-zinc-50/60 dark:hover:bg-zinc-800/30 transition-colors">
                  ...
                  <td className="py-3.5 px-4">
                    <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[9px] font-mono font-bold tracking-wider uppercase border ${
                      ex.severity === 'CRITICAL'
                        ...
                        : 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 border-indigo-200 dark:border-indigo-900'
                    }`}>
                      <span className={`w-1.5 h-1.5 rounded-full ${
                        ex.severity === 'CRITICAL' ? 'bg-rose-500' : ex.severity === 'WARNING' ? 'bg-amber-500' : 'bg-indigo-500'
                      }`} />
                      {ex.severity}
                    </span>
                  </td>
                  ...
                  <td className="py-3.5 px-4 text-right space-x-1.5">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-950/50 hover:bg-indigo-100 text-indigo-600 dark:text-indigo-400 font-semibold text-xs border border-indigo-200/60 dark:border-indigo-900/50 transition-all inline-flex items-center gap-1 cursor-pointer"
                    >
            ...
            <div className="space-y-4 text-xs">
              <div className="flex justify-between items-center bg-zinc-50 dark:bg-zinc-950 p-3 rounded-xl border border-zinc-200/80 dark:border-zinc-800/80">
                ...
                <div>
                  ...
                  <strong className="font-mono text-xs text-indigo-600 dark:text-indigo-400">{selectedExceptionDetail.category}</strong>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-2 pt-2">
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-indigo-50 dark:bg-indigo-950/50 hover:bg-indigo-100 text-indigo-600 dark:text-indigo-400 font-semibold text-xs border border-indigo-200/60 dark:border-indigo-900/50 transition-all inline-flex items-center gap-1.5 cursor-pointer"
                >
