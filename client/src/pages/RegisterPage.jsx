          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 focus:border-purple-500 dark:focus:border-purple-400 focus:ring-1 focus:ring-purple-500 dark:focus:ring-purple-400 text-zinc-900 dark:text-zinc-100 placeholder:text-zinc-400 rounded-xl pl-10 pr-3.5 py-2.5 text-xs focus:outline-none transition-all"
                required
              />
            </div>
          </div>
