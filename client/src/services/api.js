...
export const logisticsAPI = {
  ...
  preemptDock: (truckId, data) => api.post(`/trucks/${truckId}/preempt-dock`, data),
  preemptDockDirect: (data) => api.post('/docks/preempt', data),
  getASNs: () => api.get('/asn'),
...
export const financeAPI = {
  ...
  manualApprove: (id, data = {}) => api.post(`/invoices/${id}/manual-approve`, data),
