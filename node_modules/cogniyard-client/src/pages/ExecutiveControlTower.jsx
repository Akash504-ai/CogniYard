...
export default function ExecutiveControlTower() {
  ...
  const PIE_COLORS = isDark 
    ? ['#10b981', '#f43f5e', '#f59e0b', '#a855f7'] 
    : ['#059669', '#e11d48', '#d97706', '#9333ea'];
    ...
    <div className="p-6 md:p-8 space-y-6 max-w-[1600px] mx-auto min-h-screen">
            ...
            {flowNodes.map((node, index) => {
              ...
              return (
                <React.Fragment key={node.key}>
                  <div className="flex flex-col items-center p-3 rounded-xl bg-zinc-50/80 dark:bg-zinc-950 border border-zinc-200/80 dark:border-zinc-800 min-w-[105px] text-center space-y-1.5 hover:border-purple-500/40 transition-all shadow-2xs">
                    <div className="p-1.5 rounded-lg bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-purple-600 dark:text-purple-400">
                ...
                <div
                  ...
                  className={`p-3.5 rounded-xl border text-xs flex items-start justify-between gap-3 transition-all ${
                    ex.severity === 'CRITICAL'
                      ...
                      : 'bg-purple-50/70 dark:bg-purple-950/30 border-purple-200/80 dark:border-purple-900/50 text-purple-900 dark:text-purple-200'
                  }`}
                >
            ...
            {recentActivity.map((log) => (
              <div key={log._id} className="p-3 rounded-xl bg-zinc-50/80 dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800/60 text-xs space-y-1">
                <div className="flex items-center justify-between text-[10px] text-zinc-400 font-mono">
                  <span className="font-semibold text-purple-600 dark:text-purple-400">{log.user || 'System'}</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-5 rounded-2xl space-y-3 shadow-sm">
          ...
          <div className="space-y-2 text-xs font-mono">
            ...
            <div className="flex justify-between">
              ...
              <strong className="text-purple-600 dark:text-purple-400">{snapshots.procurement.activePOs}</strong>
            </div>
            <div className="flex justify-between">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-5 rounded-2xl space-y-3 shadow-sm">
          ...
          <div className="space-y-2 text-xs font-mono">
            ...
            <div className="flex justify-between">
              ...
              <strong className="text-purple-600 dark:text-purple-400">{snapshots.finance.paid}</strong>
            </div>
          </div>
        </div>
        ...
        <div 
          ...
          className="bg-gradient-to-br from-purple-500/10 via-purple-500/5 to-transparent backdrop-blur-xl border border-purple-500/30 p-5 rounded-2xl space-y-3 shadow-sm hover:border-purple-500/60 transition cursor-pointer group"
        >
          ...
          <div className="space-y-2 text-xs font-mono">
            ...
            <div className="flex justify-between">
              <span className="text-zinc-500 font-semibold text-purple-600 dark:text-purple-400">View Planning Engine →</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="space-y-2 text-xs font-mono">
            ...
            <div className="flex justify-between">
              ...
              <strong className="text-purple-400">20 / 100 (LOW)</strong>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-6 rounded-2xl shadow-sm space-y-4">
          ...
          <p className="text-[10px] text-zinc-500">Distribution of live requisition and Purchase Order records by workflow stage.</p>
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={charts.pipeline} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <XAxis dataKey="name" height={42} stroke={isDark ? '#71717a' : '#a1a1aa'} fontSize={10} tickLine={false}><Label value="Procurement Stage" position="insideBottom" offset={-5} fill={isDark ? '#a1a1aa' : '#71717a'} /></XAxis>
                <YAxis width={54} stroke={isDark ? '#71717a' : '#a1a1aa'} fontSize={10} tickLine={false}><Label value="Records" angle={-90} position="insideLeft" fill={isDark ? '#a1a1aa' : '#71717a'} /></YAxis>
                <Tooltip
                  contentStyle={{
                ...
                />
                <Bar dataKey="count" name="Records" fill={isDark ? '#a855f7' : '#9333ea'} radius={[6, 6, 0, 0]}><LabelList dataKey="count" position="top" fontSize={10} /></Bar>
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-6 rounded-2xl shadow-sm space-y-4">
          ...
          <p className="text-[10px] text-zinc-500">Distribution of live trucks across the operational lifecycle.</p>
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={charts.truckStatus} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" vertical={false} stroke={isDark ? '#27272a' : '#f4f4f5'} />
                <XAxis dataKey="name" height={42} stroke={isDark ? '#71717a' : '#a1a1aa'} fontSize={10} tickLine={false}><Label value="Truck Status" position="insideBottom" offset={-5} fill={isDark ? '#a1a1aa' : '#71717a'} /></XAxis>
                <YAxis width={54} stroke={isDark ? '#71717a' : '#a1a1aa'} fontSize={10} tickLine={false}><Label value="Trucks" angle={-90} position="insideLeft" fill={isDark ? '#a1a1aa' : '#71717a'} /></YAxis>
                <Tooltip
                  contentStyle={{
                    backgroundColor: isDark ? '#09090b' : '#ffffff',
                    borderColor: isDark ? '#27272a' : '#e4e4e7',
                ...
                />
                <Bar dataKey="count" name="Trucks" fill={isDark ? '#a855f7' : '#9333ea'} radius={[6, 6, 0, 0]}><LabelList dataKey="count" position="top" fontSize={10} /></Bar>
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white/80 dark:bg-zinc-900/60 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 p-6 rounded-2xl shadow-sm space-y-4">
          ...
          <p className="text-[10px] text-zinc-500">Distribution of real supplier invoices and payments by validation status.</p>
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
